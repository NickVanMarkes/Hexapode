...
Voici un schema qui représente la communication entre les compososants hardware et leur protocoles de communication.

![Communication](img/Diagramme_Communication.png)

## Classe Lidar

Pour le projet j'ai placé le <a href="../Composants">lidar</a> sur le haut du robot, car si je le mettais en dessous j'allais toujours détécter les pattes ce qui nous enlèverais beaucoup trop de vision. Le lidar tourne en continue car, ainsi les informations prennent moins de temps à être prises.
