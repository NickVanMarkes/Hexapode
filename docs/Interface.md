        ...
        <form method="post" action="#">
            <div class="row">
                <div class="col-sm-3 col-xl-2" id="div_Buttons">
                    ...
                    <div class="row">
                        <div class="col d-sm-flex justify-content-sm-center align-items-sm-center">
                            <button id="Arrière" type="submit" name="submit_button" value="Recule" style="border: 0; padding: 0; background: none;"><img class="Buttons_Direction" src="static/img/Arrow_Down_Key_Light.png" ></button>
                        </div>
                    </div>
                </div>
                <div class="col">
